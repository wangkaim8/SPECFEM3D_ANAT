...
echo "./combine_3_adj_src.pl HX ADJOINT_SOURCES_T005_T010 ADJOINT_SOURCES_T010_T020 ADJOINT_SOURCES_T020_T050 ADJOINT_SOURCES iker07 iker07 iker07 >>run.log " >>../job$i.sh
